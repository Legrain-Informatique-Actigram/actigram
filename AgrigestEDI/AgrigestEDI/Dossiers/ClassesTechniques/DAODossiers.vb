...
#Region "Méthodes diverses"
        Public Function GetDossier(ByVal DDossier As String) As Dossiers.ClassesMetier.Dossiers
            Dim doss As Dossiers.ClassesMetier.Dossiers = Nothing
            ...
            If (dossiersDT.Rows.Count > 0) Then
                doss = New Dossiers.ClassesMetier.Dossiers
        ...
        Public Function GetListeDossiers(ByVal DExpl As String) As Dossiers.ClassesMetier.ListeDossiers
            Dim listeDoss As New Dossiers.ClassesMetier.ListeDossiers
            ...
            For Each dossiersDR As DataSetAgrigest.DossiersRow In dossiersDT.Rows
                Dim dossier As Dossiers.ClassesMetier.Dossiers = Me.GetDossier(dossiersDR.DDossier)
        ...
        Public Sub UpdateDDtClotureTVA(ByVal DDtClotureTVA As Date, _
            ...
            If Not (DDtClotureTVA = DateTime.MinValue) Then
                Me.DossiersTA.UpdateDDtClotureTVA(DDtClotureTVA, DDossier)
            Else
                Me.DossiersTA.UpdateDDtClotureTVA(Nothing, DDossier)
            End If
        End Sub
#End Region
