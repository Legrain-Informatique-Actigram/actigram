...
#Region "Props"
    Private _nomChoix As AgrifactTracaDataSetTableAdapters.ListeChoixTableAdapter.NomsChoix
    Public Property NomChoix() As AgrifactTracaDataSetTableAdapters.ListeChoixTableAdapter.NomsChoix
        Get
            Return _nomChoix
        End Get
        Set(ByVal value As AgrifactTracaDataSetTableAdapters.ListeChoixTableAdapter.NomsChoix)
            _nomChoix = value
        End Set
    End Property

    Private ReadOnly Property CurrentChoixRow() As AgrifactTracaDataSet.ListeChoixRow
        Get
            If Me.ListeChoixBindingSource.Current Is Nothing Then
                Return Nothing
            Else
                Return DirectCast(DirectCast(Me.ListeChoixBindingSource.Current, DataRowView).Row, AgrifactTracaDataSet.ListeChoixRow)
            End If
        End Get
    End Property
#End Region
...
#Region "Constructeurs"
    ...
    Public Sub New(ByVal type As AgrifactTracaDataSetTableAdapters.ListeChoixTableAdapter.NomsChoix)
        Me.New()
        Me.NomChoix = type
    End Sub
#End Region
...
#End Region
    ...
    Private Sub ChangeOrdre(ByVal incr As Integer)
        ...
        Dim switchRow As AgrifactTracaDataSet.ListeChoixRow = Cast(Of AgrifactTracaDataSet.ListeChoixRow)(Cast(Of DataRowView)(Me.ListeChoixBindingSource.Item(Me.ListeChoixBindingSource.Position + incr)).Row)
