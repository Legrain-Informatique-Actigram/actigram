...
#Region "Constructeurs"
    ...
    Public Sub New(ByVal type As TypeCodeBarre, ByVal ean As Long, ByVal npiece As Integer)
        Me.New()
        With Me
            .Type = type
            .EAN = ean
...
#Region "Méthodes Shared "
    ...
    Public Shared Function ConstruireCodeBarre(ByVal type As TypeCodeBarre, ByVal drProduit As AgrifactTracaDataSet.ProduitRow, ByVal drBR As AgrifactTracaDataSet.ABonReceptionRow) As CodeBarre
        Dim ean As Long = 0
        Long.TryParse(Convert.ToString(drProduit("CodeBarre")), ean)
        If ean = 0 Then
            Return Nothing
        Else
...
#Region "Méthodes diverses"
    ...
    Public Function CodeBarreFormate() As String
        ...
        If str.Length = 0 Then 'OrElse str.Length > 12 Then
            Return Nothing
        Else
