...
Module IOUtils
    Public Sub LogMessage(ByVal message As String, Optional ByVal severity As TraceEventType = TraceEventType.Information)
        Debug.Print(message)
        My.Application.Log.WriteEntry(String.Format("{0} {1}", Now, message), severity)
    End Sub
...
Module FormsUtils
    ...
    Public Function GetBuildDate(ByVal v As System.Version) As DateTime
