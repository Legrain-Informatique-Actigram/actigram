...
Partial Class SqlConnectionConfig
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.ConnectionStringBuilderWrapperBindingSource.DataSource = GetType(MaquetteLectureCodeBarreSolstyce.ConnectionStringBuilderWrapper)
        '
        'ServerComboBox
        '
        ...
        Me.DatabaseComboBox.TabIndex = 3
