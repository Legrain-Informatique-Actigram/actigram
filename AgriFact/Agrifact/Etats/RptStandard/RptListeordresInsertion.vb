...
Public Class RptListeordresInsertion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptListeordresInsertion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptListeordresInsertion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptListeordresInsertion = New RptListeordresInsertion
        rpt.Site = Me.Site
        Return rpt
    End Function
