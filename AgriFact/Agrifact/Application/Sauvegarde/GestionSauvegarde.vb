...
#Region "Utils de remontée de progression"
...
#Region "Méthodes diverses"
    ...
    Public Sub Sauvegarder(ByVal fichierSauvegarde As String)
        ...
        Try
            ...
            m.Items.Add(New Fichier("Paramétrage", nonFichierParam, True))

            'Copier le repertoire Etats
            ReportProgress(50, "Sauvegarde des états")
            ...
            If IO.Directory.Exists(Application.StartupPath & "\EtatsTiers") Then
                ...
                m.Items.Add(New Dossier("Impressions et rapports spécifiques", "EtatsTiers"))
            End If

            'Ajouter les répertoires RptSats
    ...
    Private Function LireEtVerifierManifest(ByVal repDonnees As String) As ManifestSauvegarde
        ...
        Catch ex As Exception
            ...
            If MsgBox("La sauvegarde semble endommagée." & vbCrLf & _
                ...
                m.Items.Add(New DatabaseBackup("Base de données", "Donnees.bk", ""))
                m.Items.Add(New Fichier("Paramétrage", "Parametres.xml", True))
                m.Items.Add(New Dossier("Impressions et rapports", "Etats"))
                m.Items.Add(New Dossier("Impressions et rapports spécifiques", "EtatsTiers"))
                m.Items.Add(New Dossier("Impressions et rapports persos", "RptStats"))
                m.Items.Add(New Dossier("Impressions et rapports persos clients", "RptStatsClients"))
        ...
        Select Case m.Version
            ...
            Case Else 'Cas des versions de sauvegarde non gérées
                If MsgBox("Cette sauvegarde a été produite par une version plus récente de l'application." & vbCrLf & _
                "La restauration risque de rencontrer des problèmes." & vbCrLf & _
        ...
        Try
            ...
            If String.Compare(serverName, Environment.MachineName, True) <> 0 Then
                Throw New Exception("La sauvegarde des données est impossible depuis un poste distant." & vbCrLf & _
                                    "Pour sauvegarder les données vous devez executer l'application sur le poste hébergeant la base de données.")
            Else
        ...
        Try
            ...
            If String.Compare(serverName, Environment.MachineName, True) <> 0 Then
                Throw New Exception("L'import des données est impossible depuis un poste distant." & vbCrLf & _
                                    "Pour importer les données vous devez executer l'application sur le poste hébergeant la base de données.")
            End If
