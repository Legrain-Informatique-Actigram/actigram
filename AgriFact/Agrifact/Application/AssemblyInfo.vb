...
<Assembly: AssemblyTitle("AgriFact")> 
<Assembly: AssemblyDescription("Gestion commerciale AgriFact")> 
<Assembly: AssemblyCompany("Actigram")> 
<Assembly: AssemblyProduct("agriFact")> 
<Assembly: AssemblyCopyright("Actigram 2009")> 
<Assembly: AssemblyTrademark("")> 
<Assembly: CLSCompliant(True)> 

'Le GUID suivant est pour l'ID de la typelib si ce projet est exposé à COM
<Assembly: Guid("DD2AE199-255B-4E22-9B1E-74B3688A64DB")> 
