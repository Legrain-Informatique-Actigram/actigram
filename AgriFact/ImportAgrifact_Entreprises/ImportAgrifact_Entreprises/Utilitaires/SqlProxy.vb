...
#Region "Shared"
        Public Shared Function TestDefaultConnection() As Boolean
            Return TestConnection(My.Settings.AgrifactConnectionStringUserOverride)
        End Function
        ...
        Public Shared Function TestConnectionExcel(ByVal connString As String) As Boolean
            Try
                Return TestConnectionExcel(New OleDb.OleDbConnection(connString))
        ...
        Public Shared Function TestConnectionExcel(ByVal conn As OleDb.OleDbConnection) As Boolean
            Try
                If (conn.ConnectionString <> String.Empty) Then
                    conn.Open()
                Else
        ...
        Public Shared Sub SetDefaultConnection(ByVal connString As String)
            My.Settings.AgrifactConnectionStringUserOverride = connString
            My.Settings.Save()
        End Sub

        Public Shared Function GetDefaultConnection() As SqlConnection
            Return New SqlConnection(My.Settings.AgrifactConnectionStringUserOverride)
        End Function
