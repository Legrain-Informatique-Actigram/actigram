...
#Region "Gestion des connectionString"
        Public Const AgrifactConnectionStringPropertyName As String = "AgrifactConnectionString"
        Public Const EntrepriseImportExcelConnectionStringPropertyName As String = "EntrepriseImportExcelConnectionString"

        Private Shared settingsToOverride() As String = {AgrifactConnectionStringPropertyName, EntrepriseImportExcelConnectionStringPropertyName}
