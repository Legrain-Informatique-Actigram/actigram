            ...
            If VFacture = True Then
                ...
                For Each rwFacture As DataRow In rwFacturesAExporter
                    Try
                        ...
                        Ajout_Ligne(keepDossier, NumPiece, rwFacture.Item("DateFacture"), Ligne, True, "", "O", "N", IIf(CDec(rwFacture.Item("MontantTTC")) > 0, "FACTURE N°", "AVOIR N°"), NumPiece)
                        Ajout_Mouvement(keepDossier, NumPiece, rwFacture.Item("DateFacture"), Ligne, 1, CompteClient, ActiviteClient, Decimal.Round(CDec(rwFacture.Item("MontantTTC")), 2), 0, "D", 0, 0, "48800000", "0000")
                        Ajout_Mouvement(keepDossier, NumPiece, rwFacture.Item("DateFacture"), Ligne, 3, "48800000", "0000", 0, Decimal.Round(CDec(rwFacture.Item("MontantTTC")), 2), "C", 0, 0, CompteClient, ActiviteClient)
            ...
            If VReglement = True Then
                ...
                For Each rwRemise As DataRow In rwRemises
                    Try
                            ...
                            If TVASurEncaissement = True Then
                                For Each codeTVA As String In GlobalRecapTxTVA.GetLstTx()
                                    ...
                                    If dsAgrigest.Tables("TVA").Select("TTVA='" & codeTVA.Replace("'", "''") & "'", "").Length > 0 Then
                                        ...
                                        If Not IsDBNull(rwTva.Item("TCpt")) Then
                                            Ajout_Ligne(keepDossier, NumPiece, dtRemise, Ligne, True, codeTVA, rwTva.Item("TJournal"), rwTva.Item("TCtrlCl_DC"), "REGUL TVA", NumFacture)
                                    ...
                                    If dsAgrigest.Tables("TVA").Select("TTVA='" & CodeTVAEnc.Replace("'", "''") & "'", "").Length > 0 Then
                                        ...
                                        If Not IsDBNull(rwTva.Item("TCpt")) Then
                                            Ajout_Ligne_SansTVA(keepDossier, NumPiece, dtRemise, Ligne, "REGUL. TVA", NumFacture, rwTva.Item("TCpt"), "0000", "48800000", "0000", MontantTVA)
                                            Ligne += 1
                                        End If
                                    End If
                                Next
                        ...
                        Ajout_Ligne_SansTVA(keepDossier, NumPiece, dtRemise, Ligne, libLigneTotalRemise, NumFacture, CompteBanque, ActiviteBanque, "48800000", "0000", Decimal.Round(CDec(rwRemise.Item("Montant")), 2))
