...
#Region "Shared"
    ...
    '    Return TestConnection(My.Settings.ConnAgrifact, showError)
    'End Function
    ...
    '    My.Settings.SetUserOverride("ConnAgrifact", connString)
    '    My.Settings.Save()
    'End Sub

    'Public Shared Function GetDefaultConnection() As SqlConnection
    '    Return New SqlConnection(My.Settings.ConnAgrifact)
    'End Function
...
#End Region
    ...
    Public Shared Function ReplaceDbNull(Of T)(ByVal value As Object, ByVal replace As T) As T
