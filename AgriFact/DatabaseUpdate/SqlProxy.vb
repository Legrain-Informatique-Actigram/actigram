...
#End Region
    ...
    Public Sub RunScript(ByVal script As String, Optional ByVal useTransaction As Boolean = True, Optional ByVal args() As Object = Nothing)
        ...
        Dim commands() As String = Microsoft.VisualBasic.Split(script, "GO")
        Dim i As Integer = 0
        ...
        Try
            ...
            For Each command As String In commands
                ...
                If Not String.IsNullOrEmpty(sql) Then Me.ExecuteNonQuery(sql)
            Next
    ...
    Public Sub Open()
        Try
            If _conn Is Nothing Then
                Throw New Exception("La connexion n'a pas été initialisée")
            End If
