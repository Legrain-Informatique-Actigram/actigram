...
create table #tmpInv(Depot nvarchar(50),	nLot nvarchar(50),	Famille nvarchar(255),	CodeProduit nvarchar(255),	
					Libelle nvarchar(255),	SeuilStock  decimal(18,3),	LibUnite1 nvarchar(2),	LibUnite2 nvarchar(2),	
...
SELECT Depot,nLot,f.Famille,t.CodeProduit,p.Libelle,p.SeuilStock,LibUnite1,LibUnite2,
...
GROUP BY f.Famille,t.CodeProduit,Depot,nLot,p.Libelle,p.SeuilStock,LibUnite1,LibUnite2
